...
describe('Drafting Luar - Skenario Kepala Dinas', { testIsolation: false }, () => {
    ...
    qase([79, 4289, 3885, 3879, 3884, 4229, 4054, 4061, 3996, 4122, 4126, 3930, 4008, 4134, 4141, 4138],
        it('Upload dan registrasi naskah single file', () => {
            ...
            tabRegistrasiPage.inputTujuan(data_temp.env[0].staging, data_temp.registrasi[3].index0, data_temp.registrasi[4].input_internal, data_temp.registrasi[5].tujuan_kepala_dinas1)
            tabRegistrasiPage.addMoreTujuan()
            tabRegistrasiPage.inputTujuan(data_temp.env[0].staging, data_temp.registrasi[3].index1, data_temp.registrasi[4].input_internal, data_temp.registrasi[5].tujuan_kepala_dinas2)
            tabRegistrasiPage.addMoreTujuan()
            tabRegistrasiPage.inputTujuan(data_temp.env[0].staging, data_temp.registrasi[3].index2, data_temp.registrasi[4].input_internal, data_temp.registrasi[5].tujuan_kepala_dinas3)
            ...
            tabRegistrasiPage.inputPerihal('Testing Skenario E2E Tujuan Kepala Dinas ' + id, 'Testing Skenario E2E Tujuan Kepala Dinas ' + id)
