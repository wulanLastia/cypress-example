...
describe('Drafting Luar - Skenario Tujuan Tidak Didistribusikan (Tujuan Kosong)', { testIsolation: false }, () => {
    ...
    qase([4289, 3878, 3879, 3882, 3910, 3922, 4051, 4054, 4061, 4650, 4651, 4656, 3996, 4122, 4123, 4035, 3930, 4008, 4078, 4097, 4080],
        it('Upload dan registrasi naskah single file', () => {
            ...
            tabRegistrasiPage.inputPerihal('Automation Drafting Luar - Tujuan Tidak Didistribusikan (Tujuan Kosong) ' + id, 'Automation Drafting Luar - Tujuan Tidak Didistribusikan (Tujuan Kosong) ' + id)
