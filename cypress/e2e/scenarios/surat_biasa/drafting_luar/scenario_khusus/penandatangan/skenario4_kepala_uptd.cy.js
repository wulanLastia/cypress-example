...
describe('Drafting Luar - Skenario Kepala UPTD', { testIsolation: false }, () => {
    ...
    qase([79, 4289, 3885, 3879, 3884, 4229, 4054, 4061, 3996, 4122, 4126, 3930, 4008, 4134, 4141, 4138],
        it('Upload dan registrasi naskah single file', () => {
            // Login 79
            loginPage.loginViaV1(user.nip_kepala_uptd, user.password)
            ...
            // Tab Registrasi - Tujuan Surat Kepala UPTD 4229, 4054, 4061
            tabRegistrasiPage.inputTujuanTembusan()
            tabRegistrasiPage.selectLintasDinas()
            tabRegistrasiPage.inputTujuan(data_temp.env[0].staging, data_temp.registrasi[3].index0, data_temp.registrasi[4].input_internal, data_temp.registrasi[5].tujuan_kepala_uptd3)
            tabRegistrasiPage.addMoreTujuan()
            tabRegistrasiPage.inputTujuan(data_temp.env[0].staging, data_temp.registrasi[3].index1, data_temp.registrasi[4].input_internal, data_temp.registrasi[5].tujuan_kepala_uptd4)
            tabRegistrasiPage.addMoreTujuan()
            tabRegistrasiPage.inputTujuan(data_temp.env[0].staging, data_temp.registrasi[3].index2, data_temp.registrasi[4].input_internal, data_temp.registrasi[5].tujuan_kepala_uptd5)
            ...
            tabRegistrasiPage.inputPerihal('Testing Skenario E2E Penandatangan Kepala UPTD ' + id, 'Testing Skenario E2E Penandatangan Kepala UPTD ' + id)
