...
describe('Pengambilan nomor urut multiple oleh konseptor (user biasa)', () => {

    qase([1006, 1009, 1684, 1686, 1687, 1688, 1689],
        it('Create nomor urut multiple', () => {
            ...
            // Cek detail popup
            generateNomorMultiplePage.checkPopupPengambilanNomorMultiple(jenis_naskah.jenis_naskah1, uk_up.uk_kadispusipda, jumlah_pengambilan.multiple_2)
